<template>
 <div class="detail">
  ...
  <section class="con">
   ...
   <!-- 导航路径区域 -->
   <div class="conPoin">
    <span v-if="view.category1Name">{{view.category1Name}}</span>
    <span v-if="view.category2Name">{{view.category2Name}}</span>
    <span v-if="view.category3Name">{{view.category3Name}}</span>
   </div>
   ...
   <div class="mainCon">
    ...
    <div class="InfoWrap">
     <div class="goodsDetail">
      ...
      <div class="priceArea">
       <div class="priceArea1">
        ...
        <div class="price">
         <i>¥</i><em>{{goodsInfo.price}}.00</em><span>降价通知</span>
        </div>

        <div class="remark">
         <i>累计评价</i><em>65545</em>
        </div>
       </div>
       ...
       <div class="priceArea2">
        ...
        <div class="fixWidth">
         ...
         <em class="t-gray">
          ...
          或满2999.00另加40.00元，即可在购物车换购热销商品
         </em>
        </div>
       </div>
      </div>
     ...
     <div class="choose">
      ...
      <div class="cartWrap">
       <div class="controls">
        <input autocomplete="off" class="itxt" v-model="skuCount"
               @change="changeSkuCount($event)">
        <a href="javascript:" class="plus" @click="skuCount++">+</a>
        <a href="javascript:" class="mins" @click="skuCount>1?skuCount--:1">
         -
        </a>
       </div>
...
export default {
  ...
  methods:{
    ...
    changeSkuCount(event){
      ...
      else this.skuCount=parseInt(count)
    },
    ...
    async addToCart(){
      try{
        ...
        let count=this.skuCount
        await this.$store.dispatch("addToCart",{id,count})

        this.$router.push({
          name :'addcartsuccess',
          query:{skuCount:this.skuCount},
        })
